...
const Cart = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-yellow-600">
              ...
              {cartItems.map((item) => (
                ...
                >
                  ...
                  <div className="ml-4 flex-1">
                    ...
                    <p className='flex'><IndianRupee className='h-5'/>{item.price}</p>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      className="p-1 cursor-pointer text-red-500 hover:text-red-400 ml-4"
                    >
                      <Trash2 size={20} />
                    </button>
                  </div>
          ...
          <div className="bg-white/50 backdrop-blur-lg rounded-lg p-6 sticky top-24">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex justify-between">
                <span>Subtotal</span>
                <span  className='flex items-center'><IndianRupee className='h-4'/>{total.toFixed(2)}</span>
              </div>
              <div className="flex justify-between">
                <span>Delivery Fee</span>
                <span className='flex items-center'><IndianRupee className='h-4'/>5.00</span>
              </div>
              <div className="border-t border-gray-600 pt-2 mt-2">
                <div className="flex justify-between  font-bold">
                  <span>Total</span>
                  <span  className='flex items-center'><IndianRupee className='h-4'/>{(total + 5).toFixed(2)}</span>
                </div>
              </div>
            </div>
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full bg-green-700 text-white rounded-lg py-3 hover:bg-green-600 cursor-pointer"
            >
              Proceed to Checkout
            </motion.button>
          </div>
